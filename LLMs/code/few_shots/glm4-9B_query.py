...
def structure_text(original_text):
    ...
    examples = [
        {
            "input": "走失者姓名王雪莲 女 70岁 特征戴帽子穿黄色外套高1米55 走失时间20240317 走失地点辽宁省沈阳市大东区百乐小区东区",
            "output": {
                "info": {
                    "name": "王雪莲",
                    "gender": "女",
                    "missing_age": 70,
                    "missing_height": 155,
                    "missing_date": "2024-03-17",
                    "missing_location": "辽宁省沈阳市",
                    "missing_reason": "走失",
                    "description": "戴帽子穿黄色外套，失踪地点辽宁省沈阳市大东区百乐小区东区"
                }
            }
        },
        
        {
            "input": "紧急寻人！12岁女孩张晓萌，2024年3月25日在北京海淀区中关村大街走失，身高约160cm，穿粉色校服",
            "output": {
                "info": {
                    "name": "张晓萌",
                    "gender": "女",
                    "missing_age": 12,
                    "missing_height": 160,
                    "missing_date": "2024-03-25",
                    "missing_location": "北京市",
                    "missing_reason": "走失",
                    "description": "穿粉色校服，失踪地点北京海淀区中关村大街"
                }
            }
        }
